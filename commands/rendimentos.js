...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField(`<:icon_outros:1046917392514695211> | Status hoje:`, `Vendas realizadas: ${hojepedidos || "0"} \nDinheiro arrecadado: R$ ${hojerecebimentos || "0"}`, false)
        .addField(`<:icon_outros:1046917392514695211> | Status 7 dias:`, `Vendas realizadas: ${setedias || "0"} \nDinheiro arrecadado: R$ ${setediasrec || "0"}`, false)
        .addField(`<:icon_outros:1046917392514695211> | Status 30 dias:`, `Vendas realizadas: ${setedias2 || "0"} \nDinheiro arrecadado: R$ ${setediasrec2 || "0"}`, false)
